...
HourRegistration = function(date, projectNumber, activityNumber, hoursRegistered, minutesRegistered){
...
App.hourRegistrationModel =  {
    ...
    projectId: ko.observable("TestProsject"),
    activityId: ko.obserable()
